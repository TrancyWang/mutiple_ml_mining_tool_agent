...
class CatBoostRegressionTool:
    ...
    def save_shap_importance(self, output_file=None, save_dir=None):
        ...
        output_file : str, optional
            输出文件名，默认为 catboost_shap_importance_mean.xlsx
        save_dir : str, optional
            SHAP 文件保存目录，默认为实例初始化时设置的 shap_save_dir
        """
        if output_file is None:
            output_file = "catboost_shap_importance_mean.xlsx"
    ...
    def plot_actual_vs_predicted(self, output_file=None, save_dir=None):
        ...
        -----------
        output_file : str, optional
            输出文件名，默认为 catboost_figure_actual_vs_predicted.png
        save_dir : str, optional
            图片保存目录，默认为实例初始化时设置的 save_dir
        """
        if output_file is None:
            output_file = "catboost_figure_actual_vs_predicted.png"
    ...
    def plot_residual_analysis(self, output_file=None, save_dir=None):
        ...
        -----------
        output_file : str, optional
            输出文件名，默认为 catboost_figure_residual_plot.png
        save_dir : str, optional
            图片保存目录，默认为实例初始化时设置的 save_dir
        """
        if output_file is None:
            output_file = "catboost_figure_residual_plot.png"
    ...
    def plot_shap_summary(self, output_file=None, max_display=12, save_dir=None):
        ...
        -----------
        output_file : str, optional
            输出文件名，默认为 catboost_figure_shap_summary.png
        ...
        """
        if output_file is None:
            output_file = "catboost_figure_shap_summary.png"
